<?php $__env->startSection('title', 'My Orders - LuxeStore'); ?>
...
<div class="page-hero">
    <div class="breadcrumb"><a href="<?php echo e(route('home')); ?>">Home</a> / My Orders</div>
...
<div class="orders-page">
    ...
    <div class="empty-state">
        ...
        <a href="<?php echo e(route('products.index')); ?>" class="btn-shop">Browse Products</a>
    </div>
    <?php else: ?>
    <p style="color:var(--text-muted);margin-bottom:2rem;font-size:0.9rem"><?php echo e($orders->count()); ?> order(s) found</p>

    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="order-card">
        <div class="order-header">
            <div>
                <div class="order-id">Order #<?php echo e(str_pad($order->id, 5, '0', STR_PAD_LEFT)); ?></div>
                <div class="order-date"><i class="fas fa-calendar" style="color:var(--gold)"></i> <?php echo e($order->created_at->format('F d, Y')); ?></div>
            </div>
            <div style="display:flex;align-items:center;gap:1rem;flex-wrap:wrap">
                <span style="font-size:0.85rem;color:var(--text-muted)"><?php echo e(ucwords(str_replace('_',' ',$order->payment_method))); ?></span>
        ...
        <div class="order-body">
            <div class="order-items-list">
                ...
                <div class="order-item-row">
                    ...
                    <div class="item-name"><?php echo e($item->product->name ?? 'Product Unavailable'); ?></div>
                    <div class="item-qty">× <?php echo e($item->quantity); ?></div>
                    <div class="item-subtotal">PKR <?php echo e(number_format($item->price * $item->quantity, 0)); ?></div>
                </div>
        ...
        <div class="order-footer">
            <div>
                ...
                <div class="order-total">PKR <?php echo e(number_format($order->total_amount, 0)); ?></div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Manan\Downloads\luxestore-complete\ecommerce\resources\views/user/orders.blade.php ENDPATH**/ ?>