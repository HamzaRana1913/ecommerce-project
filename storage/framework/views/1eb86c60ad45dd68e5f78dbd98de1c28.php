<?php $__env->startSection('title', 'LuxeStore - Premium Shopping Experience'); ?>
...
<section class="hero">
    <div class="hero-content">
        ...
        <div class="hero-btns">
            <a href="<?php echo e(route('products.index')); ?>" class="btn-primary">Explore Products</a>
            <a href="<?php echo e(route('contact')); ?>" class="btn-outline">Get in Touch</a>
        </div>
    </div>
...
<section class="section">
    ...
    <div class="products-grid">
        <?php $__empty_1 = true; $__currentLoopData = $featured_products ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <a href="<?php echo e(route('products.show', $product->id)); ?>" class="product-card">
            ...
            <div class="product-info">
                ...
                <div class="product-price"><span class="currency">PKR </span><?php echo e(number_format($product->price, 0)); ?></div>
            </div>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <?php for($i = 1; $i <= 4; $i++): ?>
        <a href="<?php echo e(route('products.index')); ?>" class="product-card">
            <div class="product-img">
            ...
            <div class="product-info">
                ...
                <div class="product-name">Luxury Product <?php echo e($i); ?></div>
                <div class="product-price"><span class="currency">PKR </span><?php echo e(number_format(rand(2000, 20000), 0)); ?></div>
            </div>
        </a>
        <?php endfor; ?>
        <?php endif; ?>
...
<section class="section" style="background:var(--cream-2);padding:5rem 5%;">
    ...
    <div class="categories-grid">
        <a href="<?php echo e(route('products.index')); ?>?category=electronics" class="cat-card">
            <div class="cat-icon">⚡</div>
            <div class="cat-name">Electronics</div>
            <div class="cat-count">150+ items</div>
        </a>
        <a href="<?php echo e(route('products.index')); ?>?category=fashion" class="cat-card">
            <div class="cat-icon">👔</div>
            <div class="cat-name">Fashion</div>
            <div class="cat-count">200+ items</div>
        </a>
        <a href="<?php echo e(route('products.index')); ?>?category=home" class="cat-card">
            <div class="cat-icon">🏠</div>
...
<div class="cta-banner">
    ...
    <a href="<?php echo e(route('register')); ?>" class="btn-primary">Create Account — It's Free</a>
</div>
<div style="margin-bottom:6rem;"></div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Manan\Downloads\luxestore-complete\ecommerce\resources\views/home.blade.php ENDPATH**/ ?>