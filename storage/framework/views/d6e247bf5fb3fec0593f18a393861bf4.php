<?php $__env->startSection('title', 'Contact Us - LuxeStore'); ?>
        ...
        <form action="<?php echo e(route('contact.store')); ?>" method="POST" id="contactForm">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="Muhammad Ali">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="+92 300 0000000">
                </div>
                <div class="form-group">
                    <label>Subject *</label>
                    <select name="subject" required>
                        <option value="">Select a subject...</option>
                        <option value="order_inquiry" <?php echo e(old('subject') == 'order_inquiry' ? 'selected' : ''); ?>>Order Inquiry</option>
                        <option value="product_question" <?php echo e(old('subject') == 'product_question' ? 'selected' : ''); ?>>Product Question</option>
                        <option value="return_refund" <?php echo e(old('subject') == 'return_refund' ? 'selected' : ''); ?>>Return / Refund</option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <textarea name="message" required placeholder="Write your message here..."><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Manan\Downloads\luxestore-complete\ecommerce\resources\views/contact.blade.php ENDPATH**/ ?>