...
<head>
    ...
    <title>@yield('title', 'Admin Panel') — LuxeStore</title>
...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-logo">
            <a href="{{ route('admin.dashboard') }}">Luxe<span>Store</span></a>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.orders.index') }}" class="nav-item {{ request()->routeIs('admin.orders*') ? 'active' : '' }}">
                ...
                <span class="nav-badge">{{ \App\Models\Order::where('status','pending')->count() ?? 0 }}</span>
            </a>
            <a href="{{ route('admin.order-items.index') }}" class="nav-item {{ request()->routeIs('admin.order-items*') ? 'active' : '' }}">
            ...
            <a href="{{ route('home') }}" class="nav-item" target="_blank" style="margin-top:auto">
    ...
    <div class="main-content">
        <div class="topbar">
            ...
            <div class="topbar-right">
                <a href="{{ route('home') }}" class="topbar-btn" title="View Store" target="_blank"><i class="fas fa-store"></i></a>
                <a href="{{ route('admin.products.create') }}" class="topbar-btn" title="Add Product"><i class="fas fa-plus"></i></a>
            </div>
        </div>
