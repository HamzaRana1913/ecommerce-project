...
<head>
    ...
    <title>@yield('title', 'LuxeStore - Premium Shopping')</title>
...
<body>
    <nav>
        <a href="{{ route('home') }}" class="nav-logo">Luxe<span>Store</span></a>
        <ul class="nav-links">
        ...
        <div class="nav-actions">
            @guest
                <a href="{{ route('login') }}" style="color:rgba(255,255,255,0.7);text-decoration:none;font-size:0.9rem;">Login</a>
                <a href="{{ route('register') }}" class="cart-btn">Register</a>
            @else
                <span style="color:rgba(255,255,255,0.6);font-size:0.85rem;">Hi, {{ auth()->user()->name }}</span>
    ...
    <footer>
        <div class="footer-grid">
            <div class="footer-brand">
                <a href="{{ route('home') }}" class="nav-logo">Luxe<span style="color:white">Store</span></a>
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('checkout.index') }}">My Orders</a></li>
                </ul>
            </div>
        </div>
        <div class="footer-bottom">
            <span>© {{ date('Y') }} LuxeStore. All rights reserved.</span>
